...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                <?php if ($hosts['Host_Status'] == 'pending_verify'): ?>
                    <li><a href="add-property.php" title="ลงทะเบียนบ้านพักใหม่" class="active"><i
                    ...
                    <form id="formInput">
                        ...
                        <div class="form-row-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="property_province" name="province" class="form-input" value=""
                                    required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="property_district" name="district" class="form-input" value=""
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row-4">
                                    <label class="form-label-details">ชื่อบริการ :<input type="text" placeholder="1"
                                            class="form-input" value="" name="services_name"></label>
                                    <label class="form-label-details">รายละเอียดบริการ :<textarea
                                            name="services_description" placeholder="" class="form-input">

                                                </textarea></label>
                                    <label class="form-label-details">ชื่อกิจกรรม :<input type="text" placeholder="1"
                                            class="form-input" value="" name="activity_name"></label>
                                    <label class="form-label-details">รายละเอียดกิจกรรม :<textarea
                                            name="activity_description" placeholder="" class="form-input">
                                    </textarea></label>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        // 1. ประกาศตัวแปร marker แต่ยังไม่สร้าง
        let marker;

        // 2. เมื่อคลิกที่แผนที่
        map.on('click', function(e) {
            ...
            // ตรวจสอบว่ามี marker อยู่แล้วหรือยัง
            if (marker) {
                // ถ้ามีแล้ว -> ให้ย้ายตำแหน่ง
                marker.setLatLng(e.latlng);
            } else {
                // ถ้ายังไม่มี -> ให้สร้างขึ้นมาใหม่ และแนบ event การลาก
        ...
        document.getElementById("property_district").addEventListener("change", function() {
            ...
            fetch(apiUrl, {
                    method: 'GET', // <--- แก้ไข: ใส่เครื่องหมายคำพูด
                    headers: {
                ...
                .then(data => {
                    if (data && data.length > 0) {
                        ...
                        // ตรวจสอบ marker อีกครั้งก่อนใช้งาน
                        if (marker) {
    ...
    <script>
        ...
        addBtn.addEventListener("click", () => {
          ...
          <button type="button" class="btn btn-remove"><i class="fa-solid fa-delete-left"></i></button>
                ...
                alert(`สร้างฟอร์มได้สูงสุด ${maxForms} ฟอร์มเท่านั้น!`);
            }
        });
        // ฟอร์มลบทั้งหมด
