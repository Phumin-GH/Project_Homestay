...
<body>
    ...
    <div class="auth-container" id="auth-container">
        ...
        <div class="auth-header">
            ...
            <h1>ยินดีต้อนรับเจ้าบ้านกลับมา</h1>
        ...
        <div class="auth-content">
            <form id="login-form" class="form-content active" action="../../controls/log_hosts.php" method="post">
                ...
                <p class="form-subtitle">Eกรอกข้อมูลประจำตัวของคุณเพื่อเข้าถึงบัญชีของคุณ</p>
            ...
            <div id="signup-form" class="form-content" action="../../controls/log_hosts.php" method="post">
                ...
                <div class="form-group">
                    <label for="login-id-card">บัตรประจำตัวประชาชน/label>
                        <input type="id_card" id="signup-id_card" name="id_card" placeholder="x xxx xxx xxxx xxx "
                            required>
                </div>
                <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="forgot-form">
                    <div class="form-group">
                        ...
                        <input type="email" id="forgot-email" placeholder="example@gmail.com" name="email" required>
                    </div>
