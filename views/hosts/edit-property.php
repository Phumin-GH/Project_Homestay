                                    ...
                                    <?php foreach ($room as $i => $num): ?>
                                        <div class="form-row-4">
                                            ...
                                            <label class="form-label-detail">สถานะ:<select class="form-input"
                                                    name="selectValue[]">
                                                    <option
                                                        value="<?php echo htmlspecialchars(($num['Room_status'] == 0 ? "ว่าง" : ($num['Room_status'] == 1 ? "ไม่ว่าง" : ($num['Room_status'] == 2 ? "ปิด" : "ไม่ทราบ")))); ?>">

                                                        ปัจจุบัน
                                                        (<?php echo htmlspecialchars(($num['Room_status'] == 0 ? "ว่าง" : ($num['Room_status'] == 1 ? "ไม่ว่าง" : ($num['Room_status'] == 2 ? "ปิด" : "ไม่ทราบ")))); ?>
                                                        )
                                                    </option>
