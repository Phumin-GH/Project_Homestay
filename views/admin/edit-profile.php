    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="profile.php" title="ข้อมูลส่วนตัว" class="active"><i class="fas fa-user"></i><span
        ...
        <div class="main-with-sidebar">
            <div class="edit-container">
                ...
                <form class="edit-form" method="POST" action="../../controls/log_admin.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="phone-input-container">
                                ...
                                <input type="tel" name="phone" class="form-input phone-input"
                                    value="<?php echo htmlspecialchars($admin['Admin_phone'] ?? ''); ?>"
