    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="manage-reviews.php" title="รีวิวจากผู้ใช้" class="active"><i class="fas fa-star"></i><span
        ...
        <div class="main-with-sidebar">
            <div class="main-content">
                <div class="page-header">
                    <h1><i class="fa-solid fa-house-medical-circle-check"></i> การจัดการรีวิวบ้านพัก</h1>
                ...
                <?php /*endif;*/ ?>
                <?php if (count($AllProperty) > 0): ?>
                <h2>รายชื่อบ้านพักทั้งหมด ( <?php echo count($AllProperty) ?> )</h2>
                <section class="homestay-list">
                    <?php foreach ($AllProperty as $house): ?>
