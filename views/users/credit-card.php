...
<body>
    <div class="container">
        <div class="left-side">
            <div
                style="display: flex; flex-direction:column; align-items: center; margin: 2rem 0; height: 300px; padding: 2rem;">
                <img src="../../public/images/logo/Mastercard.png" alt="Mastercard"
                    style="width: 400px; margin-bottom:5rem;">
                <img src="../../public/images/logo/Visa-Logo.png" alt="Visa" style="width: 400px;">
            </div>
        </div>
    ...
    function setCancelLoading(isLoading) {
        payBtn.classList.toggle('is-disabled', isLoading);
        payBtn.classList.add('loading');
        payBtn.textContent = isLoading ? 'ยกเลิกชำระเงิน...' :
            'ยกเลิก';
    }
