...
<head>
    ...
    <title>รายการโปรด - Homestay Booking</title>
            ...
            <div class="favorites-container">
                    ...
                    <div class="favorites-grid">
                        <?php foreach ($favorites as $favorite): ?>
                            <div class="favorite-card"
                                data-property-id="<?php echo htmlspecialchars($favorite['Property_id']); ?>">
                                <img src="../../public/<?php echo htmlspecialchars($favorite['Property_image']); ?>"
                                    ...
                                    <div class="favorite-actions">
                                        ...
                                        <form method="post" action="detail_house.php" style="display:inline;">
                                            <input type="hidden" name="house_id"
                                                value="<?php echo htmlspecialchars($favorite["Property_id"]); ?>">
                                            <button class="btn btn-primary" type="submit">จองตอนนี้</button>
                                        </form>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>เริ่มสำรวจและบันทึกโฮมสเตย์ที่คุณชื่นชอบเพื่อดูที่นี่</p>
