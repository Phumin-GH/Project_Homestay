            ...
            <div class="container">
                ...
                <div class="rooms-list" id="roomsList">
                    <?php foreach ($rooms as $room): ?>
                        <div class="room-card <?php echo htmlspecialchars($room['Room_status'] != 'Available'  ? ' disable' : ''); ?>"
                            ...
                            <div
                                class="room-status <?php echo ($room['Room_status'] == 'Available' ? 'Available' : ($room['Room_status'] == 'Reserved' ? 'Reserved' : 'Closed')); ?>">
                ...
                <div class="booking-map-flex">
                    <div class="map-section" style="flex:1; min-width:280px;">
                        ...
                        <?php /*if ($maps_url):*/ ?>
                        <div id="map" style="width:100%; height:660px; border-radius:10px; margin-top:0.1rem;"></div>
                        <?php /*else: */ ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            rooms.forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    prices_amount.value = selectedRoomPrice;
                                ...
                                fetch('../../controls/bookings_room.php', {
                                    ...
                                    .then(data => {
                                        if (data.gateway === "qrcode") {
                                            alert(`คุณยืนยันต้องการชำระผ่าน ${data.gateway}`);
