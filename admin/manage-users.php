            ...
            <div class="admin-container">
                ...
                <div class="auth-tabs">
                    <div class="tab active" id="user-active-tab">
                        <i class="fas fa-sign-in-alt"></i> User active
                    </div>
                    <div class="tab" id="user-banned-tab">
                        <i class="fas fa-user-plus"></i> User banned
                    </div>
                    <div class="tab" id="user-inactive-tab">
                        <i class="fas fa-user-plus"></i> User inactive
                    </div>
                </div>
                <div class="table-responsive active" id="user-active-section">
                    <?php if (count($users) > 0): ?>
                    <?php echo "<h1 class='UserH2'>รายชื่อทั้งหมด Active (" . count($users) . ")</h1>" ?>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>ลำดับ</th>
                ...
                <div class="table-responsive " id="user-inactive-section" style="display:none;">
                    ...
                    <?php echo "<h1 class='UserH2'>รายชื่อทั้งหมด Inactive (" . count($inactive_user) . ")</h1>" ?>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>ลำดับ</th>
                ...
                <div class="table-responsive " id="user-banned-section" style="display:none;">
                    ...
                    <?php echo "<h1 class='UserH2'>รายชื่อทั้งหมด Banned (" . count($ban_user) . ")</h1>" ?>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>ลำดับ</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                            $status = ($user['User_Status'] == 'banned') ? "Banned" : "Active";
