...
class Host
{
    ...
    public function approve_host($approved, $host_id)
    {
    ...
    public function cancel_host($cancel, $host_id)
    {
        $sql = "UPDATE host SET Host_status = ? WHERE Host_id = ?";
        $stmt = $this->conn->prepare($sql);
    ...
    public function edit_host($firstname, $lastname, $email, $phone, $host_id)
    {
    ...
    public function reject_host($reject, $host_id)
    {
        $sql = "UPDATE host SET Host_Status = ? WHERE Host_id = ?";
        $stmt = $this->conn->prepare($sql);
    ...
    public function ban_host($baned, $host_id)
    {
        $sql = "UPDATE host SET Host_Status = ? WHERE Host_id = ?";
        $stmt = $this->conn->prepare($sql);
