...
<head>
    ...
    <title>Edit Profile - Homestay Booking</title>
        ...
        <div class="main-with-sidebar">
            <div class="edit-container">
                ...
                <form class="edit-form" method="POST" action="../controls/log_users.php">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" class="form-input"
                                    value="<?php echo htmlspecialchars($users['Firstname']); ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">นามสกุล <span style="color:red">*</span></label>
                                <input type="text" name="lastname" class="form-input"
                                    value="<?php echo htmlspecialchars($users['Lastname']); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">อีเมล</label>
                            <input type="email" class="form-input"
                                value="<?php echo htmlspecialchars($users['User_email']); ?>" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="phone-input-container">
                                ...
                                <input type="tel" name="phone" class="form-input phone-input"
                                    value="<?php echo htmlspecialchars($users['Phone'] ?? ''); ?>"
                    ...
                    <!-- Buttons -->
                    <div class="btn-group">
                        <button type="submit" class="btn btn-primary" name="save_edit" id="save_edit">
