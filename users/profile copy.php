                    ...
                    <div class="info-grid">
                        <div class="info-section">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value"><?php echo htmlspecialchars($user['User_firstname']); ?></div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">นามสกุล</div>
                                <div class="info-value"><?php echo htmlspecialchars($user['User_lastname']); ?></div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">
                                    ...
                                    <span class="phone-display">
                                        <span class="phone-prefix-display">66+</span>
                                        <span
                                            class="phone-number"><?php echo htmlspecialchars($user['User_phone']); ?></span>
                                    </span>
                                    <?php else: ?>
