...
<head>
    ...
    <style>
        ...
        .page-header h1 {
            ...
            /* ทำให้ h1 พอดีกับความกว้างของข้อความ */
            position: relative;
...
<body>
                    ...
                    <div class="form-card">
                        ...
                        <form id="formInput">
                            <div class="upload-wrapper">
                                <img class="box-img" src="../<?php echo htmlspecialchars($house['Property_image']); ?>"
                                    alt="">
    ...
    <script>
        const latitude = "<?php echo (int)$house['Property_latitude']; ?>";
        const longitude = "<?php echo (int)$house['Property_longitude']; ?>";
