...
// $stmt = $conn->prepare("
//     SELECT Host_id,Host_firstname, Host_lastname, Create_at, Host_phone, Host_email, Host_IdCard 
//     FROM host 
//     WHERE Host_email = ?
// ");
// $stmt->execute([$email]);
        ...
        <div class="main-with-sidebar">
            <div class="dashboard-container">
                ...
                <div class="page-header">
                    ...
                    <p>Welcome back,
                        <?php echo htmlspecialchars($hosts['Host_firstname'] . ' ' . $hosts['Host_lastname']); ?>!</p>
                </div>
                <!-- Statistics Cards -->
